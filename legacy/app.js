...
// ─── Response Time Prediction (calls the Python model API) ─────────────────
...
async function getPredictedResponseTime(features) {
  try {
    ...
    return await res.json(); // { predicted_minutes, confidence_interval }
  } catch (err) {
