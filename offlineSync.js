...
// Save pending item to offline queue
...
// Cache local data snapshot (for offline viewing)
...
// Sync pending queue to Firebase Firestore
...
// Update UI elements displaying network status and queue count
...
export function initOfflineSync(db, firestoreMethods) {
  ...
  window.addEventListener('offline', () => {
    console.warn('Network connection lost. App operating in offline-first mode.');
    updateOfflineUI();
  });
